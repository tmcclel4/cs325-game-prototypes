  ...
  var game = new Phaser.Game( 800, 600, Phaser.AUTO, 'game', { preload: preload, create: create, update: update, render:render } );
   ...
   // var timer1;
    ...
    function create() {
       ...
       // {
//            if (time%5 === 0)
       //          m = missiles.create(game.world.randomX, game.world.randomY, 'missile');
      //           m.body.gravity.y = 10;
      //  }
       ...
       // astroid.body.onCollide.add(hitSprite, this);
...
//        var style = { font: "25px Verdana", fill: "#22aaff", align: "right" };
//        time = Math.floor(game.time.time/1000%60);
//        var text = game.add.text(0, 30, "Time: "+time, style );
//        if (time === 15)
//          this.endGame;
